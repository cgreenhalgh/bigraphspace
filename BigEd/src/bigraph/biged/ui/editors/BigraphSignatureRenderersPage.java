...
public class BigraphSignatureRenderersPage extends FormPage
{
	private TreeViewer viewer;

	public BigraphSignatureRenderersPage(final FormEditor editor, final String id, final String title)
	{
	...
	private Section createTableSection(final IManagedForm managedForm)
	{
		...
		viewer.setContentProvider(new ITreeContentProvider()
		{
			...
			{
				if (parentElement instanceof Control) { return ((Control) parentElement).getPort().toArray(); }
				return null;
			}

			public Object[] getElements(final Object inputElement)
			{
				final Definitions definition = getDefinitions();
				if (definition != null && definition.getRenderers() != null) { return getDefinitions().getRenderers()
						.getRenderer().toArray(); }
				return new Object[] {};
			}
			...
			{
				if (element instanceof Control) { return !((Control) element).getPort().isEmpty(); }
				return false;
			}
