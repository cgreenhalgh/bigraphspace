 ...
 */
public class BigraphSignatureEditorContributor extends MultiPageEditorActionBarContributor
{
	 ...
	 */
	public BigraphSignatureEditorContributor()
	{
		super();
		createActions();
	}
	...
	private void createActions()
	{
		sampleAction = new Action()
		{
			...
			public void run()
			{
				MessageDialog.openInformation(null, "ARTECT", "Sample Action Executed");
			}
		};
